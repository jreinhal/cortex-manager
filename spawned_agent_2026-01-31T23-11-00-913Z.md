...
## CURRENT OBJECTIVE
Perform a visual regression test on the homepage using browser automation

## PROVIDED RESOURCES
### KNOWLEDGE
No specific resources found.
### SKILLS
--- RESOURCE: VISUAL_GUIDE.vi.md ---
...
**Approach:** Test all parameters, try type coercion, test boundaries, c
... (truncated)

--- RESOURCE: ab_test_planner.py ---
"""
